...
class SKSpearSuper : SKAbstractSprite {
    func loadTextures() {
    ...
    func getAttackUPSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_up_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    ...
    func getAttackUPLEFTSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_ul_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    ...
    func getAttackUPRIGHTSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_ur_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    ...
    func getAttackDOWNSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_down_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    ...
    func getAttackDOWNLEFTSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_dl_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    //
    ...
    func getAttackDOWNRIGHTSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_dr_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    //
    ...
    func getAttackLEFTSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_left_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    ...
    func getAttackRIGHTSequence_Frames() -> [SKTexture] {
        ...
        let imageName = "SpearSuper_right_stand"
        textures.append(self.AlteredTexture(imageNamed: imageName))
        return textures
    }
    ...
    func getWalkUpSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_up_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_up_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_up_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_up_walk04")
    ...
    func getWalkDownSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_down_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_down_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_down_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_down_walk04")
    ...
    func getWalkLeftSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_left_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_left_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_left_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_left_walk04")
    ...
    func getWalkRightSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_right_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_right_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_right_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_right_walk04")
    ...
    func getWalkULSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_ul_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_ul_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_ul_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_ul_walk04")
    ...
    func getWalkURSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_ur_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_ur_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_ur_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_ur_walk04")
    ...
    func getWalkDLSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_dl_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_dl_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_dl_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_dl_walk04")
    ...
    func getWalkDRSequence_Frames() -> [SKTexture] {
        ...
        let imageName1 = self.AlteredTexture(imageNamed: "SpearSuper_dr_walk01")
        let imageName2 = self.AlteredTexture(imageNamed: "SpearSuper_dr_walk02")
        let imageName3 = self.AlteredTexture(imageNamed: "SpearSuper_dr_walk03")
        let imageName4 = self.AlteredTexture(imageNamed: "SpearSuper_dr_walk04")
